...
from crucible.data import get_dataset, get_template_and_fix_tokenizer
from crucible.extras.constants import IGNORE_INDEX
from crucible.extras.misc import get_device_count
from crucible.extras.packages import is_vllm_available
from crucible.hparams import get_infer_args
from crucible.model import load_tokenizer
...
def vllm_infer(
    ...
    # The result matrix is referencing src.crucible.train.sft.workflow.run_sft # 127~132
