...
If LLaMA Factory was already installed in the virtual environment, remove it with `pip uninstall crucible` before reinstalling it in editable mode with the -e flag.
